...
local function show_group_settingsmod(msg, data, target)
  ...
  local text = "›Group Settings:\n♻️•••Kick new member with link : "..settings.lock_join.."\n♻️•••Lock group Fosh : "..settings.antifosh.."\n♻️•••Lock group chat : "..settings.lock_chat.."\n♻️•••Lock group ads : "..settings.antiads.."\n♻️•••Lock group name : "..settings.lock_name.."\n♻️•••Lock group photo : "..settings.lock_photo.."\n♻️•••kick new member : "..settings.lock_member.."\n♻️•••Lock leave ban : "..leave_ban.."\n♻️•••flood set on : "..NUM_M.nan bots come :"..bots_protection.."                                        ›»Nod32 People Version 7.8 (◉_◉)"
  return text
end
